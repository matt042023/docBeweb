...
// 1. Décommentez le code de Enzo ci-dessous
// 2. Rédigez le corps de la fonction afficherAdresseClient
// let nom = "Enzo REDOCEMIA";
// let numeroRue = 21;
...
// Pour faire cet exercice : 
// 1. Décommentez le code de Enzo ci-dessous
// 2. Rédigez le code manquant juste après le code de Enzo
...
// <===== VOTRE CODE ICI: Insérez/modifiez le code à partir d'ici =====>
// D'ici vous avez accès à toutes les variables précédemment déclarées dont l'adresse de Enzo (nom, numeroRue, nomRue, codePostal, ville), adresseMagiciensDuCode et numeroClient.
...
// Chassez le bogue ! 0
// Enzo a découpé son code en plusieurs fonctions, décommentez-le et corrigez les bogues !
